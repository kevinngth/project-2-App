                        ...
                        <div className="col-6 p-5">
                            <form method="POST" action='/notes/addNote' id="noteFormSubmit">
                                ...
                                <div className="form-group">
                                    <label>Notes</label>
                                    <textarea id="notes" className="form-control" rows="3" name="notes" value={notes} placeholder="Your notes here" disabled required></textarea>
                                </div>
                                <div className="form-group">
                                    <a id="notesEditButton" className="form-control btn btn-dark"><i className="fas fa-edit"></i></a><br/>
                                </div>
                                <div className="form-group">
                        ...
                        <div className="col-6 p-5 border-left border-dark">
                            <form method="POST" action={"/collection/"+id+"?_method=patch"} id="collectionFormSubmit">
                                <div className="form-group">
                                    ...
                                    <input id="db" type="date" className="form-control" name="date_bought" defaultValue={date} disabled required/>
                                </div>
                                <div className="form-group">
                                    <label>Balance</label><br/>
                                    <input id="balance" type="range" className="custom-range" min="0" max="10" step="1" defaultValue={balance} disabled name="balance"/>
                                </div>
                                <div className="form-group">
                                    <a id="collectionEditButton" className="form-control btn btn-dark"><i className="fas fa-edit"></i></a><br/>
                                </div>
                                <div className="form-group">
                                    <input className="form-control btn btn-dark" type="submit" defaultValue="Submit"/>
                                </div>
